  ...
  <view class="sk-container">
    <scroll-view scroll-y="true" class="viewport viewport" enable-back-to-top="true">
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-718 sk-text">99.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-437 sk-text"
            >90%白鸭绒，儿童轻羽绒马甲73-130cm</view
          >
          <view class="desc sk-transparent sk-text-0-0000-251 sk-text"
            >儿童轻羽绒马甲，保暖常备单品app</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-170 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-51 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-756 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-557 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-327 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-875 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-550 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-534 sk-text">属性名</text>
              <text class="value sk-transparent sk-text-25-0000-44 sk-text">属性值</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-32-9268-67 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-32-9268-608 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
